...
int main(){
  std::vector<LutEntry> lut;std::string err;assert(loadCube33("resources/Referent_LogC4_to_Rec709.cube",lut,&err));assert(lut.size()==35937);
  ...
  // New v1.4 camera-filter and ToneLab-skin controls remain finite and image-dependent.
