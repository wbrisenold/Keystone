...
CGDIR="$BUNDLE/Contents/Resources/NativeMatch/NativeMatch.ofx.bundle/Contents/MacOS"
test -d "$CGDIR"
CGBIN="$(find "$CGDIR" -maxdepth 1 -type f -print -quit)"
test -n "$CGBIN"; test -f "$CGBIN"
